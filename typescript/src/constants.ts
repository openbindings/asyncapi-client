...
/** Marks an operation or message whose declared trait reference could not be
 * resolved, so partial application can never look faithful. */
export const UNRESOLVED_TRAIT_TAG = "x-ob-asyncapi-unresolved-trait";
